...
- Fixed broken product gallery images whose thumbnails could not be resolved — invalid and duplicate srcset entries are no longer emitted, so the image correctly falls back to the original
